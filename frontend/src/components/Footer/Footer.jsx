...
const quickLinks02=[
  ...
  {
    path:"/",
    display:"Request an apppointment",
   },
  {
      path:"/",
  ...
  return (
    ...
    <div className="container">
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            <img src={logo} alt="" />
            <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>Copyright &#169; developed by Ruturaj Chandgude all rights reserved.</p>
