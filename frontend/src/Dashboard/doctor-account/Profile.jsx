...
const Profile = ({doctorData}) => {
  ...
  //reusuable funcion for adding item
  const addItem = (key, item) => {
    setFormData(prevFormData => ({ ...prevFormData, [key]: [...prevFormData[key], item] }))
  }


  //reusable input chnage fucntion
  ...
  const addQualification = e => {
    ...
    addItem('qualifications', {
      startingDate: '', endingDate: '', degree: 'PHD', university: 'AIIMS Delhi'
    })
  ...
  const addTimeSlot= e => {
    e.preventDefault();
    addItem('timeSlots', {
       day: 'Monday', startingTime: '10:00', endingTime: '4:30' 
    })
  ...
  const addExperience= e => {
    e.preventDefault();
    addItem('experiences', {
      startingDate: '', endingDate: '', position:'Senior Surgeon', hospital:'Jaslok Hospital'
    })
    ...
    <div>
      ...
      <form >
        ...
        {/* <div className='mb-5'>
          ...
          {formData.qualifications?.map((item,index)=>( <div key={index}>
            <div>
              ...
              <div className='grid grid-cols-2 gap-5'>
                <div>
                  <p className="form_label mt-4">Starting Date*</p>
                  <input type="date" name='startingDate' value={item.startingDate} className='form_input' onChange={e=>handleQualificationChange(e,index)}/> 
                </div> 
                <div>
                  <p className="form_label mt-4">Ending Date*</p>
                  <input type="date" name='endingDate' value={item.endingDate}  className='form_input' onChange={e=>handleQualificationChange(e,index)}/>  
                </div> 
              </div> 
              ...
              <button onClick={e=>deleteQualification(e,index)} className='bg-red-600 p-2 rouunded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer'><AiOutlineDelete/></button>
            </div>
          </div>))}
        ...
        <div className='mb-5'>
          ...
          {formData.experiences?.map((item, index) => (<div key={index}>
            <div>
              ...
              <button onClick={e => deleteExperience(e, index)} className='bg-red-600 p-2 rouunded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer'><AiOutlineDelete /></button> 
            </div>
          </div>))}
            ...
            <div>
              <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5'>
                ...
                <div onClick={e=>deleteTimeSlot(e,index)}  className='flex items-center'>
                  <button className='bg-red-600 p-2 rouunded-full text-white text-[18px] mt-6 cursor-pointer'><AiOutlineDelete /></button>
                </div>
              </div>
        ...
        <div className='mb-5'>
          ...
          <textarea name="about" rows={5} value={formData.about} placeholder='Write about you' onChange={handleInputChange} className='form_input'>
        ...
        <div className='mt-7'>
          <button type='submit' onClick={updateProfileHandler} className='bg-primaryColor text-white text-[18px] leading-[30px] w-full py-3 px-4 rounded-lg'>Update Profile
          </button>
        </div>
