...
const Tabs = ({ tab, setTab }) => {
  ...
  return (
    ...
    <div>
      ...
      <div className='hidden lg:flex flex-col p-[30px] bg-white shadow-panelShadow center h-max rounded-md'>
        <button
          onClick={() => setTab("overview")} className={`${tab === "overview" ? "bg-indigo-100 text-primaryColor" : "bg-transparent text-headingColor"} w-full btn mt-0 rounded-md`}>Overview</button>
