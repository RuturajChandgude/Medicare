    ...
    <div className='grid grid-cols-1 lg:grid-cols-2'>
      ...
      <div className='rounded-l-lg lg:pl-16 py-10'>
        ...
        <div className='mb-5'>
          ...
          <div className='mt-7'>
            <button disabled={loading && true} type='submit' className='w-full bg-primaryColor text-white text-[18px] leading-[38px] rounded-lg px-4 py-3'>{loading?(<HashLoader size={35} color='#ffffff'/>):('Sign Up')}</button>
          </div>
