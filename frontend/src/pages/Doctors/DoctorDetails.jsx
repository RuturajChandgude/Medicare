       ...
       {!loading && !error && ( <div className='grid md:grid-cols-3 gap-[50px]'>
          <div className='md:col-span-2'>
            <div className='flex items-center gap'>
              ...
              <div>
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded ml-4'>{specialization}</span>
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 ml-4 font-bold'>{name}</h3>
                <div className='flex items-center gap-[6px]'>
                  <span className='flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor ml-4'>
                    <img src={starIcon} alt="" />{averageRating}
                  </span>
                  <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400] text-textColor'>({totalRating})</span>
                </div>
                <p className='text_para text-[14px] ml-4 leading-5 md:text-[15px] lg:max-w-[390px]'>{bio}
                </p>
              </div>
            </div>
