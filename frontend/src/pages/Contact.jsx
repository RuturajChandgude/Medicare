      ...
      <div className='px-4 mx-auto max-w-screen-md'>
        ...
        <form action="#" className='space-y-8'>
           <div>
            ...
            <input type="email"
            id='email' placeholder='example@gmail.com' className='form_input mt-1' />
           </div>
           <div>
            <label htmlFor="subject" className='form_label'>Subject</label>

            <input type="text"
            id='subject' placeholder='Let us know how we can help you' className='form_input mt-1' />
           </div>
           <div className='sm:col-span-2'>
            <label htmlFor="message" className='form_label'>Your Message</label>

            <textarea type="text" rows="6" 
            id='message' placeholder='Leave a comment...' className='form_input mt-1' />
           </div>
